...
color 0A
echo --------------------------------------------------
echo [PASSO 1/7] Instalacao do Node.js
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
echo.
echo --------------------------------------------------
echo [PASSO 2/7] Instalando Dependencias do Backend
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
echo.
echo --------------------------------------------------
echo [PASSO 3/7] Configuracao do Ambiente (.env)
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
echo.
echo --------------------------------------------------
echo [PASSO 4/7] Configuracao do Firebird (firebird.conf)
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
echo.
echo --------------------------------------------------
echo [PASSO 5/7] Scripts de Banco de Dados
echo --------------------------------------------------
timeout /t 1 >nul
...
echo ##################################################
echo #                                                #
echo #      ATENCAO: RODAR SCRIPTS NO BANCO!!         #
echo #                                                #
echo ##################################################
echo.
echo O arquivo de script sera aberto automaticamente em 5 segundos...
echo.
echo 5...
timeout /t 1 >nul
echo 4...
...
:: Volta para branco antes de abrir
color 07
...
if exist "criar_views_gabarito.bat" (
    ...
    echo [AVISO] Arquivo 'criar_views_gabarito.bat' nao encontrado.
    echo Abrindo a pasta atual para voce localizar...
    start .
)

echo.
echo Quando terminar de rodar os scripts no banco de dados,
...
echo.
echo --------------------------------------------------
echo [PASSO 6/7] Instalacao do Servico Windows (Gabarito)
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
echo.
echo --------------------------------------------------
echo [PASSO 7/7] Abrindo Sistema Web
echo --------------------------------------------------
timeout /t 1 >nul
color 07
...
if exist "Abrir_Web.bat" (
    call Abrir_Web.bat
) else (
    echo [AVISO] Arquivo 'Abrir_Web.bat' nao encontrado.
