...
SELECT P.CDPRODUTO, P.PRODUTO, P.CDUNIDADE, SE.IDEMPRESA, SE.NRPEDIDO, SP.IDPRECO,
       SP.CDDEPOSITO, COALESCE(SP.VLUNIT,0), IIF(COALESCE(SP.VLCUSTO,0) > 0, SP.VLCUSTO, COALESCE(PP.VLCUSTO,0)),
       ...
       TB.TABPROMOCAO, P.COD_CENTRAL, P.CDFABRICANTE, P.CDFORNECEDOR, P.CDGRUPO, P.GRUPO,
