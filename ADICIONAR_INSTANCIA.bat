...
title Gabarito - Adicionar Instancia Adicional
color 07
...
echo ##################################################
echo #                                                #
echo #      GABARITO - NOVA INSTANCIA (BANCO)         #
echo #                                                #
echo ##################################################
echo.
...
:ASK_NAME
set "INSTANCE_NAME="
set /p INSTANCE_NAME="Digite um NOME para esta instancia (ex: Gabarito_Filial) [Sem espacos]: "
if "!INSTANCE_NAME!"=="" (
